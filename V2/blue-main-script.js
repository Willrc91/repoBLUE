...
class AuthenticationMethod extends Multilanguage {
    constructor(settings, securityValidator) {
        ...
        this.settings.otpDeliveryMethodCode = this.settings.otpDeliveryMethodCode ? this.settings.otpDeliveryMethodCode : OTPDeliveryMethodCodes.SMS;
...
class CBAC extends AuthenticationMethod {
    ...
    validate() {
        ...
        (_a = document.querySelector("#loadingContainer")) === null || _a === void 0 ? void 0 : _a.classList.remove("d-none");
        let response = this.settings.backendAccessMethods.validateDFA(this.cbacInput.val());
        if (response) {
    ...
    showValidate() {
        ...
        (_c = document.querySelector("#nextStepTempPassBtn")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => {
            this.settings.callback(pluginResponses.SUCCESS_RESPONSE);
        });
        var cbacMethod = this;
    ...
    handleCbacValidationResponse(result) {
        ...
        if (!result) {
            if (this.contadorIntentos >= this.maxIntentos) {
                this.settings.callback(pluginResponses.MAX_RETRY_RESPONSE);
            }
            else {
...
class CBAC_SMS extends AuthenticationMethod {
    ...
    show() {
        this.showValidate();
        let response = this.settings.backendAccessMethods.sendDFA(this.settings.userInfo.userId, this.settings.userInfo.country);
        if (response) {
            this.processResult(response);
        }
    }
    ...
    resend() {
        ...
        if (this.contadorReenvio >= this.maxReenvio) {
            this.settings.callback(pluginResponses.MAX_RESEND_CBAC_SMS_RESPONSE);
        }
        else {
            this.dfaStep = 'SEND';
            let response = this.settings.backendAccessMethods.sendDFA(this.settings.userInfo.userId, this.settings.userInfo.country);
...
"use strict";
var OTPDeliveryMethodCodes;
(function (OTPDeliveryMethodCodes) {
    OTPDeliveryMethodCodes["EMAIL"] = "1";
    OTPDeliveryMethodCodes["SMS"] = "2";
})(OTPDeliveryMethodCodes || (OTPDeliveryMethodCodes = {}));
var pluginResponses;
(function (pluginResponses) {
    pluginResponses["SUCCESS_RESPONSE"] = "success";
    pluginResponses["MAX_RETRY_RESPONSE"] = "maxRetry";
    pluginResponses["MAX_RESEND_OTP_RESPONSE"] = "maxResendOTP";
    pluginResponses["MAX_RESEND_CBAC_SMS_RESPONSE"] = "maxResendCBAC";
    pluginResponses["GO_TO_WHATSAPP_RESPONSE"] = "goToWhatsApp";
    pluginResponses["NO_TOKEN_ACCESS_RESPONSE"] = "noTokenAccess";
...
class OTP extends AuthenticationMethod {
    ...
    validate() {
        ...
        this.contadorIntentos++;
        (_a = document.querySelector("#loadingContainer")) === null || _a === void 0 ? void 0 : _a.classList.remove("d-none");
        let response = this.settings.backendAccessMethods.validateOTP(this.otpInput.val());
        if (response) {
            this.processResult(response);
        }
    }
    ...
    showGenerate() {
        ...
        (_b = document.querySelector("#goWhatsAppLink")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
            this.settings.callback(pluginResponses.GO_TO_WHATSAPP_RESPONSE);
        });
        (_c = document.querySelector("#sendCodeBtn")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => {
            let response = this.settings.backendAccessMethods.sendOTP(this.settings.userInfo.userId, this.settings.userInfo.country);
            if (response) {
                this.processResult(response);
            }
        });
    ...
    resend() {
        this.contadorReenvio++;
        if (this.contadorReenvio >= this.maxReenvio) {
            this.settings.callback(pluginResponses.MAX_RESEND_OTP_RESPONSE);
        }
        else {
            this.otpStep = 'SEND';
            let response = this.settings.backendAccessMethods.sendOTP(this.settings.userInfo.userId, this.settings.userInfo.country);
...
class Token extends AuthenticationMethod {
    ...
    validate() {
        ...
        this.contadorIntentos++;
        (_a = document.querySelector("#loadingContainer")) === null || _a === void 0 ? void 0 : _a.classList.remove("d-none");
        let response = this.settings.backendAccessMethods.validateDFA(this.tokenInput.val());
        if (response) {
            this.processResult(response);
        }
    }
    ...
    showValidate() {
        ...
        (_a = document.querySelector("#securityvalidatorviewmodel")) === null || _a === void 0 ? void 0 : _a.append(footer);
        (_b = document.querySelector("#noAccessLink")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
            this.settings.callback(pluginResponses.NO_TOKEN_ACCESS_RESPONSE);
        });
        (_c = document.querySelector("#nextStepTempPassBtn")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => {
            this.settings.callback(pluginResponses.SUCCESS_RESPONSE);
        });
